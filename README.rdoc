...
- delay in server response needs an alert popup instead of initial alert;
- map not recentering!
...
TM
- error handling + validation bollocks
- responsive map_canvass (TRIED, not yet)
- enter handle for address bar
- header: address.val(); (DONE!)
- linkto button

MC
- login validation
- modal header and footer styling inc title
- navbar styling

SM
- map canvas styling
- godaddy.com uploading
...
- ajax handler
create hidden div, animated spinner
show div with click event
hid when ajax returns done event
